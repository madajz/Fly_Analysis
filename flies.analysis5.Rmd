...
```{r Long-Pval,fig.width=6,fig.height=3+length(unique(df.m$Group))/16.5}
p_val_heatmap(format_heat(res.all))
...
```{r Long-FC, fig.width=6,fig.height=3+length(unique(df.m$Group))/16.5}
...
```{r Fecundity-pval, fig.width=6,fig.height=3+length(unique(df.m$Group))/16.5}
...
```{r Fecundity-FC,fig.width=6,fig.height=3+length(unique(df.m$Group))/16.5}
...
```{r Awake-pval,  fig.width=6,fig.height=3+length(unique(df.m$Group))/16.5}
...
```{r Awake-FC,  fig.width=6,fig.height=3+length(unique(df.m$Group))/16.5}
...
```{r Activity-Awake-pval,fig.width=6,fig.height=3+length(unique(df.m$Group))/16.5}
p_val_heatmap(format_heat(res.all))
```
...
```{r Activity-Awake-FC, fig.width=6,fig.height=3+length(unique(df.m$Group))/16.5}
...
```{r Sleep-pval, fig.width=6,fig.height=3+length(unique(df.m$Group))/16.5}
p_val_heatmap(format_heat(res.all))
```
...
```{r Sleep-FC, fig.width=6,fig.height=3+length(unique(df.m$Group))/16.5}
...
```{r Total-Sleep-pval,  fig.width=6,fig.height=3+length(unique(df.m$Group))/16.5}
p_val_heatmap(format_heat(res.all))
```
...
```{r Total-Sleep-FC, fig.width=6,fig.height=3+length(unique(df.m$Group))/16.5}
...
```{r Immune-pval,fig.width=6,fig.height=3+length(unique(df.m$Group))/16.5}
p_val_heatmap(format_heat(res.all))
...
```{r Immune-FC,fig.width=6,fig.height=3+length(unique(df.m$Group))/16.5}
...
```{r RING-pval,  fig.width=6,fig.height=3+length(unique(df.m$Group))/16.5}
p_val_heatmap(format_heat(res.all))
...
```{r RING-FC, fig.width=6,fig.height=3+length(unique(df.m$Group))/16.5}
